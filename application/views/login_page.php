...
<head>
    ...
    <title>Espaço Coração</title>

  <link rel="stylesheet" type="text/css" href="<?= base_url("assets/css/bootstrap.min.css");?>">
	    <link rel="stylesheet" type="text/css" href="<?= base_url("assets/style/login.css"); ?>">
...
<!--<div class="container" >
 <div class="move">
    ...
    <form action="<?=base_url();?>index.php/Cardio_public_c/cardio_first_page">  
     <div class="form-group">
